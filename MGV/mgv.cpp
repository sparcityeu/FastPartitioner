...
int main(int argc, char *argv[])
{
    ...
    CLI::Option *opt6 = app.add_option("-g", gpu_enabled_CLI, "use GPU for refinement, default is 0");
    ...
    { //use id's to order
      ...
      if(GPE){
	partition_gpu(row_ptr, col_ind, net_appearence, nov, noe, pins, edge_wgths, src_nodes, K, ordering, f_name, REFI_OPT, REFI_ITER);
      }
      else{
